...
def _dashboard_runtime_config() -> Dict[str, Any]:
    ...
    return {
        ...
        "ai_extreme_risk_cancel_buyback": settings.ai_extreme_risk_cancel_buyback,
        "ai_extreme_full_block_requires_external_risk_off": settings.ai_extreme_full_block_requires_external_risk_off,
        "ai_extreme_recovery_probe_max_equity_fraction": settings.ai_extreme_recovery_probe_max_equity_fraction,
        "ai_extreme_external_risk_off_threshold": settings.ai_extreme_external_risk_off_threshold,
        ...
        "uptrend_confirmation_entry_enabled": settings.uptrend_confirmation_entry_enabled,
        "uptrend_confirmation_passive_offset_pct": settings.uptrend_confirmation_passive_offset_pct,
        "uptrend_confirmation_max_equity_fraction": settings.uptrend_confirmation_max_equity_fraction,
        "uptrend_confirmation_extra_slot": settings.uptrend_confirmation_extra_slot,
