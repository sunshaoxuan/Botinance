...
class Settings:
    ...
    order_reprice_tolerance_pct: float = 0.006
    order_reprice_min_age_seconds: int = 300
    ...
    sell_cost_protection_enabled: bool = True
    sell_cost_protection_buffer_pct: float = 0.0015
    allow_below_cost_sell_for_risk_exit: bool = True
    allow_below_cost_sell_for_rebalance: bool = False
...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        order_reprice_tolerance_pct=float(os.getenv("ORDER_REPRICE_TOLERANCE_PCT", "0.006")),
        order_reprice_min_age_seconds=int(os.getenv("ORDER_REPRICE_MIN_AGE_SECONDS", "300")),
        ...
        sell_cost_protection_enabled=_parse_bool(os.getenv("SELL_COST_PROTECTION_ENABLED"), True),
        sell_cost_protection_buffer_pct=float(os.getenv("SELL_COST_PROTECTION_BUFFER_PCT", "0.0015")),
        allow_below_cost_sell_for_risk_exit=_parse_bool(os.getenv("ALLOW_BELOW_COST_SELL_FOR_RISK_EXIT"), True),
        allow_below_cost_sell_for_rebalance=_parse_bool(os.getenv("ALLOW_BELOW_COST_SELL_FOR_REBALANCE"), False),
